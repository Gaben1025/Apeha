...
public class EnemyController : MonoBehaviour
{
    ...
    public int attackDamage = 25;                   //  Attack Damage
    public float attackRange = 2;                   //  Attack Range
    private float attackSpeed = 2f;                 //  Attack Speed in seconds
    ...
    float timeOfLastAttack = 0f;                    //  Time of the last attack of the enemy
    void Start()
    {
    ...
    private void Chasing()
    {
        ...
        if (navMeshAgent.remainingDistance <= attackRange && Time.time - timeOfLastAttack > attackSpeed)
        {
            m_CaughtPlayer = true;
    ...
    public void Die()
    {
        ...
        {
            Instantiate(coinPrefab, deathPos, Quaternion.identity);
        }
